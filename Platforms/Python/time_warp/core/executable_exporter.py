...
"""
    ...
    def export_python_executable(
        self, code: str, output_path: Path, include_console: bool = True
    ) -> Tuple[bool, str]:
        """
    ...
    def export_web_app(
        ...
        try:
            ...
            return (
                True,
                f"Web app created in: {output_dir}\n"
    ...
    def export_shell_script(
        self, code: str, output_path: Path, language: str = "BASIC"
    ) -> Tuple[bool, str]:
...
"""
    ...
    def create_installers(
        self, code: str, output_dir: Path, app_name: str
        ...
        results["windows"] = self.export_python_executable(
            code, output_dir / f"{app_name}.exe"
        )

        # Shell script (Linux/macOS)
        results["unix"] = self.export_shell_script(code, output_dir / app_name)

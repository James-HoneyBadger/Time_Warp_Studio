...
class CodeReviewSession:
    ...
    def add_comment(self,
                   ...
                   severity: Optional[SeverityLevel] = None) -> CodeComment:
...
"""
        ...
        # Comment breakdown
        issues = [c for c in self.get_all_comments() if c.comment_type == CommentType.ISSUE]
        suggestions = [c for c in self.get_all_comments() if c.comment_type == CommentType.SUGGESTION]
        questions = [c for c in self.get_all_comments() if c.comment_type == CommentType.QUESTION]
...
class PeerReviewManager:
    ...
    def create_review(self,
                     ...
                     code: str,
                     language: str,
                     description: str = "") -> CodeReviewSession:
    ...
    def submit_review(self,
                     ...
                     scores: Optional[Dict[str, int]] = None) -> float:

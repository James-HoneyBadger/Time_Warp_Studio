...
class AssetLibrary:
    ...
    def import_asset(self, file_path: Path, 
    ...
    def export_manifest(self) -> Dict:
        ...
        manifest = {
            'library': self.get_library_info().__dict__,
            'assets': []
        }
...
class SpriteAnimator:
    ...
    def __init__(self, sprite_asset: Asset, frame_count: int, frame_width: int, frame_height: int):
    ...
    def get_current_frame_rect(self) -> Tuple[int, int, int, int]:
        ...
        x = (self.current_frame % (self.sprite.width // self.frame_width)) * self.frame_width
        y = (self.current_frame // (self.sprite.width // self.frame_width)) * self.frame_height

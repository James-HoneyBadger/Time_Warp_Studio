...
class HardwareSimulator:
    ...
    def set_device_value(self, device_id: str, value: float) -> bool:
        ...
        self._log_event('device_value_set', {
            'device_id': device_id,
    ...
    def inject_sensor_data(self, sensor_id: str, 
                          value: float,
    ...
    def simulate_motion(self, duration: float, 
    ...
    def get_sensor_history(self, sensor_id: str, 
    ...
    def _generate_sensor_data(self, sensor_id: str, 
                             device: SimulatedDevice) -> SensorReading:

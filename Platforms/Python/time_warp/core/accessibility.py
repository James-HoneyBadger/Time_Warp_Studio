...
class AccessibilityManager:
    ...
    def set_magnification(self, level: float):
        ...
        self._trigger_callbacks('magnification_changed', level=self.settings.magnification_level)
    ...
    def set_font_size(self, multiplier: float):
        ...
        self._trigger_callbacks('font_size_changed', multiplier=self.settings.font_size_multiplier)
    ...
    def set_line_spacing(self, multiplier: float):
        ...
        self._trigger_callbacks('line_spacing_changed', multiplier=self.settings.line_spacing_multiplier)
...
class ScreenReaderSupport:
    ...
    def describe_turtle_graphics(turtle_state: Dict) -> str:
        ...
        return (f"Turtle at position {turtle_state.get('x', 0)}, {turtle_state.get('y', 0)} "
                f"facing {turtle_state.get('angle', 0)} degrees, "
                f"pen is {'down' if turtle_state.get('pen_down', True) else 'up'}")

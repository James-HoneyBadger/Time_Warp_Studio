...
- Removed all Python implementations (legacy GUI entry points and interpreter modules)
- Removed legacy implementations (Time Warp II, historical Rust subdirectories)
